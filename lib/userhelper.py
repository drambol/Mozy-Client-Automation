...
class UserHelper(object):
    ...
    @classmethod
    def __init__(self, billing_address =None, billing_city = None, billing_state =None, billing_country =None,billing_zip =None,external_id=None,language =None,name = None,password=None,status = None,username=None,user_group_id =None,email_verified_at=None,type = None,install_region=None,sync=None, **kwargs):
        ...
        self.pk = kwargs.get('pk') or None

    @classmethod
    def set_username(cls,username):
        if username != None:
            cls.username = str(username)
        else:
