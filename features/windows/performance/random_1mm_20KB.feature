Feature: As a mozy backup software user, I can backup large number of files
  ...
  @KAL-9006 @long @windows-performance
  Scenario: backup 1000000 * 20KB files
#    When I backup performance backupset includes 1000000 files with 20480 byte random content
    When I create 1000000 test files with
      | file_folder | file_prefix | file_size | file_ext | file_name |
      | testdata/1mm     | wp     | 20480      |    txt      | perf      |
