Feature: As a mozy backup software user, I can backup large number of files
  ...
  @KAL-9004 @long @windows-performance
  Scenario: backup 200000 * 20KB files
#    When I backup performance backupset includes 200000 files with 20480 byte random content
    When I create 200000 test files with
      | file_folder | file_prefix | file_size | file_ext | file_name |
      | testdata/200k     | wp     | 20480      |    txt      | perf      |
