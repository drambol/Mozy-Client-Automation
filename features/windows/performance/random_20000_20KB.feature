Feature: As a mozy backup software user, I can backup large number of files
  ...
  @KAL-9001 @long @windows-performance
  Scenario: backup 20000 * 20KB files
#    When I backup performance backupset includes 20000 files with 20480 byte random content
    When I create 20000 test files with
      | file_folder | file_prefix | file_size | file_ext | file_name |
      | testdata/20k     | wp     | 20480      |    dat      | perf      |
