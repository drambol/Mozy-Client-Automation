Feature: As a mozy backup software user, I can backup large number of files
  ...
  @KAL-9105 @long @windows-performance
  Scenario: backup large (100 GB) file
    # 100 GB
#    When I backup performance backupset includes 1 files with 107374182400 byte random content
    When I create 1 test files with
      | file_folder | file_prefix | file_size | file_ext | file_name |
      | win-perf-100G     | wp     | 107374182400      |    dat      | perf      |
