Feature: As a mozy backup software user, I can backup large number of files
  ...
  @KAL-9104 @long @windows-performance
  Scenario: backup large (50 GB) file
    # 50 GB
#    When I backup performance backupset includes 1 files with 53687091200 byte random content
    When I create 1 test files with
      | file_folder | file_prefix | file_size | file_ext | file_name |
      | win-perf-50G     | wp     | 53687091200      |    dat      | perf      |
