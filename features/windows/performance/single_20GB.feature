Feature: As a mozy backup software user, I can backup large number of files
  ...
  @KAL-9103 @long @windows-performance
  Scenario: backup large (20 GB) file
    # 20 GB
#    When I backup performance backupset includes 1 files with 21474836480 byte random content
    When I create 1 test files with
      | file_folder | file_prefix | file_size | file_ext | file_name |
      | win-perf-20G     | wp     | 21474836480      |    dat      | perf      |
