Feature: As a mozy backup software user, I can backup large number of files
  ...
  @KAL-9106 @long @windows-performance
  Scenario: backup large (200 GB) file
    # 200 GB
#    When I backup performance backupset includes 1 files with 214748364800 byte random content
    When I create 1 test files with
      | file_folder | file_prefix | file_size | file_ext | file_name |
      | win-perf-100G     | wp     | 214748364800      |    dat      | perf      |
