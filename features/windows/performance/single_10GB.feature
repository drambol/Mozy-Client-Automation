Feature: As a mozy backup software user, I can backup large number of files
  ...
  @KAL-9102 @long @windows-performance
  Scenario: backup large (10 GB) file
    # 10 GB
#    When I backup performance backupset includes 1 files with 10737418240 byte random content
    When I create 1 test files with
      | file_folder | file_prefix | file_size | file_ext | file_name |
      | win-perf-10G     | wp     | 10737418240      |    dat      | perf      |
